...
public interface ITutorialLevelCalendarRepository extends CrudRepository<TutorialLevelCalendar, Long> {
    ...
    @Query("Select tutorialLevelCalendar From TutorialLevelCalendar tutorialLevelCalendar Where tutorialLevelCalendar.studentTutorialLevel =?1 Order By tutorialLevelCalendar.calendarItemOrder ASC ")
