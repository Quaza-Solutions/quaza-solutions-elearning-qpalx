...
public class DefaultIEPaymentTransactionService implements IEPaymentTransactionService {
    ...
    public void recordEPaymentTransaction(final PaymentTransactionRecord paymentTransactionRecord) {
        Assert.notNull(paymentTransactionRecord, "paymentTransactionRecord cannot be null");
        LOGGER.info("Saving paymentTransactionRecord: {}", paymentTransactionRecord);
        ...
        Runnable persistEPaymentTransactionRunnable = () -> {
            ...
            iePaymentServiceTransactionRepository.save(paymentTransactionRecord);
        };
